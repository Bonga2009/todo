  ...
  Widget build(BuildContext context) {
    ...
    body: 
     ...
     Card(
        ...
        ListTile(
          leading:  IconButton(onPressed: (){}, icon: Icon(Icons.check_circle_outline_outlined), color: Colors.black,),
             title: Text("Go for a party.", style:TextStyle(fontSize:15,fontWeight: FontWeight.w800, color: Colors.blue),
             
        ),
        subtitle: Text("Go with Ali to chill", style:TextStyle(fontSize:12,fontWeight: FontWeight.w500, color: Colors.black),
        ),
        ),
          ),
            Card(
        ...
        ListTile(
          leading:  IconButton(onPressed: (){}, icon: Icon(Icons.check_circle_outline_outlined), color: Colors.black,),
             title: Text("Go to swimming in Tarkwa,Ghana.", style:TextStyle(fontSize:15,fontWeight: FontWeight.w800, color: Colors.blue),
             
        ),
        subtitle: Text("Go with Bene", style:TextStyle(fontSize:12,fontWeight: FontWeight.w500, color: Colors.black),
        ),
        ),
          ),
            Card(
        ...
        ListTile(
          leading:  IconButton(onPressed: (){}, icon: Icon(Icons.check_circle_outline_outlined), color: Colors.black,),
             title: Text("Get my car from workshop.", style:TextStyle(fontSize:15,fontWeight: FontWeight.w800, color: Colors.blue),
             
        ),
        subtitle: Text("Mark drives me home", style:TextStyle(fontSize:12,fontWeight: FontWeight.w500, color: Colors.black),
        ),
        ),
          ),
           Card(
